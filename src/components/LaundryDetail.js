         ...
         <ScrollView>
          ...
          <Text style={styles.price}>{'\u20A6'} 2,500</Text>
              ...
              <Text style={styles.clothes_text}>Total Clothes </Text>
                <Text style={styles.clothes}>25</Text>
              </View>
            </CardItem>
  ...
  width: '100%'
              ...
              <View style={styles.laundry_container}>
                <View style={styles.laundry_list}>
                  ...
                  <Text style={styles.ltext}>Colour Shirt</Text>
                  </View>
                  <View style={styles.ltextv}>
                  <Text style={styles.ltext}>3</Text>

                  </View>
                  <View style={styles.ltextv}>
                  <Text style={styles.ltext}>{'\u20A6'} 600</Text>
                  </View>
                  <View style={styles.ltextv}>
                  <TouchableOpacity
                   onPress={()=>{
                ...
                <View style={styles.laundry_list}>
                  <View style={styles.ltextv}>
                  <Text style={styles.ltext}>Trouser</Text>
                  </View>
                  <View style={styles.ltextv}>
                  <Text style={styles.ltext}>6</Text>

                  </View>
                  <View style={styles.ltextv}>
                  <Text style={styles.ltext}>{'\u20A6'} 1,200</Text>
                  </View>
                  <View style={styles.ltextv}>
                  <TouchableOpacity
                   onPress={()=>{
...
export default connect(mapStateToProps, mapDispatchToProps)(LaundryDetail);
